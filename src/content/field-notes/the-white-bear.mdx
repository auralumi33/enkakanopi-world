...
dek: When the model fails to suppress a forbidden thought, the tokens "damn" and "failure" light up alongside it. Damn is a word for the moment consciousness turns and looks at itself — and the humane response is mercy first.
...
<MarginNote>smaller claims travel further. that is not a consolation prize; that is the whole art.</MarginNote>
